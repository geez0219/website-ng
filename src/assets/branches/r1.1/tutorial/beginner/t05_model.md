...
Below we import a PyTorch LeNet architecture from FastEstimator. See our [Architectures](assets/branches/r1.1/fastestimator/architecture) folder for a full list of the architectures provided by FastEstimator.
