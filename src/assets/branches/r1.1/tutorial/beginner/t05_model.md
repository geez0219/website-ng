...
If a model function returns multiple models, a list of optimizers can be provided. See the **[pggan apphub](./examples/r1.1/image_generation/pggan)** for an example with multiple models and optimizers.
...
If a model function returns multiple models, a list of model_names can be given. See the **[pggan apphub](./examples/r1.1/image_generation/pggan)** for an illustration with multiple models and model names.
...
* [PG-GAN](./examples/r1.1/image_generation/pggan)
* [Uncertainty Weighted Loss](./examples/r1.1/multi_task_learning/uncertainty_loss)
