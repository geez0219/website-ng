## HadamardCode<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/layers/pytorch/hadamard.py/#L25-L131>View source on Github</a>
```python
HadamardCode(
