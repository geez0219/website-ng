...
## load_data<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/dataset/data/montgomery.py/#L30-L79>View source on Github</a>
```python
load_data(
