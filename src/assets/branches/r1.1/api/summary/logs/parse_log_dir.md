## parse_log_dir<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/summary/logs/log_parse.py/#L98-L130>View source on Github</a>
```python
parse_log_dir(
	dir_path: str,
