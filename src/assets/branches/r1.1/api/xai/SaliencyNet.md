## SaliencyNet<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/xai/saliency.py/#L44-L262>View source on Github</a>
```python
SaliencyNet(
	model: ~Model,
