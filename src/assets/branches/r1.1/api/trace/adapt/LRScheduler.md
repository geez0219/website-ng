## LRScheduler<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/trace/adapt/lr_scheduler.py/#L31-L74>View source on Github</a>
```python
LRScheduler(
