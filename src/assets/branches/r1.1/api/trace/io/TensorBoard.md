## TensorBoard<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/trace/io/tensorboard.py/#L263-L425>View source on Github</a>
```python
TensorBoard(
	log_dir: str='logs',
