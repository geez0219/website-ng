## ConfusionMatrix<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/trace/metric/confusion_matrix.py/#L27-L78>View source on Github</a>
```python
ConfusionMatrix(
	true_key: str,
	pred_key: str,
