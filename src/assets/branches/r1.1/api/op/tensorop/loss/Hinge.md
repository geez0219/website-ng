## Hinge<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/tensorop/loss/hinge.py/#L29-L53>View source on Github</a>
```python
Hinge(
