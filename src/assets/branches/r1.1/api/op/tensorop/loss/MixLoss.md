## MixLoss<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/tensorop/loss/mix_loss.py/#L27-L71>View source on Github</a>
```python
MixLoss(
