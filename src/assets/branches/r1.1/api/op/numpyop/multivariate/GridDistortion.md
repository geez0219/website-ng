## GridDistortion<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/multivariate/grid_distortion.py/#L25-L84>View source on Github</a>
```python
GridDistortion(
	num_steps: int=5,
