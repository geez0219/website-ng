## RandomSizedCrop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/multivariate/random_sized_crop.py/#L26-L93>View source on Github</a>
```python
RandomSizedCrop(
