## SmallestMaxSize<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/multivariate/smallest_max_size.py/#L26-L81>View source on Github</a>
```python
SmallestMaxSize(
	max_size: int=1024,
	interpolation: int=1,
