## CenterCrop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/multivariate/center_crop.py/#L25-L79>View source on Github</a>
```python
CenterCrop(
	height: int,
	width: int,
...
* **width**: Width of the crop. Image types: uint8, float32 (but uint8 is more efficient)
