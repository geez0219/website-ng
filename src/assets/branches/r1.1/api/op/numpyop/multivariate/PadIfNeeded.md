## PadIfNeeded<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/multivariate/pad_if_needed.py/#L26-L92>View source on Github</a>
```python
PadIfNeeded(
	min_height: int=1024,
	min_width: int=1024,
...
* **mask_value**: Padding value for mask if border_mode is cv2.BORDER_CONSTANT. Image types: uint8, float32
