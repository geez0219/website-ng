## RandomCrop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/multivariate/random_crop.py/#L25-L79>View source on Github</a>
```python
RandomCrop(
	height: int,
	width: int,
...
* **width**: Width of the crop. Image types: uint8, float32
