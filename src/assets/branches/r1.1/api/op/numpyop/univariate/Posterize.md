## Posterize<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/univariate/posterize.py/#L24-L48>View source on Github</a>
```python
Posterize(
