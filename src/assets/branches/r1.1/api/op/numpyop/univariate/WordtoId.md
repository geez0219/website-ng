## WordtoId<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/univariate/word_to_id.py/#L24-L67>View source on Github</a>
```python
WordtoId(
