## ReadImage<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.1/fastestimator/op/numpyop/univariate/read_image.py/#L26-L74>View source on Github</a>
```python
ReadImage(
