...
* [UNET](examples/r1.0/semantic_segmentation/unet/unet)
* [DCGAN](examples/r1.0/image_generation/dcgan/dcgan)
* [Siamese Networks](examples/r1.0/one_shot_learning/siamese_network/siamese)
