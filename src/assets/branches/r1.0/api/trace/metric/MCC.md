## MCC<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/trace/metric/mcc.py/#L25-L75>View source on Github</a>
```python
MCC(
	true_key: str,
	pred_key: str,
