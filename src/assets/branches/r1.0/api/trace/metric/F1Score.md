## F1Score<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/trace/metric/f1_score.py/#L25-L78>View source on Github</a>
```python
F1Score(
	true_key: str,
	pred_key: str,
