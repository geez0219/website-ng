## Saliency<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/trace/xai/saliency.py/#L36-L168>View source on Github</a>
```python
Saliency(
	model: ~Model,
