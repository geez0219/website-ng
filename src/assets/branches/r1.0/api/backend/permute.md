## permute<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/backend/permute.py/#L24-L65>View source on Github</a>
```python
permute(
	tensor: ~Tensor,
