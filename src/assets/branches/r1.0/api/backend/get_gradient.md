## get_gradient<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/backend/get_gradient.py/#L25-L85>View source on Github</a>
```python
get_gradient(
	target: ~Tensor,
