## to_tensor<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/backend/to_tensor.py/#L24-L70>View source on Github</a>
```python
to_tensor(
