## to_number<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/backend/to_number.py/#L22-L58>View source on Github</a>
```python
to_number(
