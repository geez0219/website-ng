## reduce_mean<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/backend/reduce_mean.py/#L26-L84>View source on Github</a>
```python
reduce_mean(
	tensor: ~Tensor,
