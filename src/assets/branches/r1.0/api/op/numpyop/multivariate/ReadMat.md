## ReadMat<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/read_mat.py/#L23-L48>View source on Github</a>
```python
ReadMat(
	file: str,
