## RandomSizedCrop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/random_sized_crop.py/#L24-L91>View source on Github</a>
```python
RandomSizedCrop(
