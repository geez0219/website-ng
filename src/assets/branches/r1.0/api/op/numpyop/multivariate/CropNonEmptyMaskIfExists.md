## CropNonEmptyMaskIfExists<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/crop_non_empty_mask_if_exists.py/#L23-L88>View source on Github</a>
```python
CropNonEmptyMaskIfExists(
	height: int,
	width: int,
	ignore_values: Union[List[int], NoneType]=None,
	ignore_channels: Union[List[int], NoneType]=None,
...
* **ignore_channels**: Channels to ignore in mask (e.g. if background is a first channel set `ignore_channels=[0]` to ignore). Image types: uint8, float32
