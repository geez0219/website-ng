## VerticalFlip<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/vertical_flip.py/#L23-L73>View source on Github</a>
```python
VerticalFlip(
