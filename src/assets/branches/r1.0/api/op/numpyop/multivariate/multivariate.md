# fastestimator.op.numpyop.multivariate.multivariate<span class="tag">module</span>
---
## MultiVariateAlbumentation<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/multivariate.py/#L24-L91>View source on Github</a>
```python
