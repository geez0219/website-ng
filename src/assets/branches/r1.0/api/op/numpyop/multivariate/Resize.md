## Resize<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/resize.py/#L24-L81>View source on Github</a>
```python
Resize(
	height: int,
	width: int,
