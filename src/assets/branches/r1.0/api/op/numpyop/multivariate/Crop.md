## Crop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/crop.py/#L23-L81>View source on Github</a>
```python
Crop(
	x_min: int=0,
	y_min: int=0,
