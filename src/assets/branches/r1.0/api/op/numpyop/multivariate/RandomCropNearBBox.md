## RandomCropNearBBox<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/random_crop_near_bbox.py/#L23-L75>View source on Github</a>
```python
RandomCropNearBBox(
