## CenterCrop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/numpyop/multivariate/center_crop.py/#L23-L77>View source on Github</a>
```python
CenterCrop(
	height: int,
	width: int,
