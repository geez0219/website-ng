## Gather<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/tensorop/gather.py/#L28-L71>View source on Github</a>
```python
Gather(
