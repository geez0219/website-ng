## FGSM<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/tensorop/gradient/fgsm.py/#L30-L66>View source on Github</a>
```python
FGSM(
	data: str,
	loss: str,
