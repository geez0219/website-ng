## Argmax<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/op/tensorop/argmax.py/#L26-L47>View source on Github</a>
```python
Argmax(
