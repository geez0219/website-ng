## build<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/network.py/#L619-L694>View source on Github</a>
```python
build(
