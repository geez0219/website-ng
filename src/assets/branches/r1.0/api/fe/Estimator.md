## Estimator<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/estimator.py/#L41-L466>View source on Github</a>
```python
Estimator(
