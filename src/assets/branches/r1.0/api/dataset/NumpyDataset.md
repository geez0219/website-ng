## NumpyDataset<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.0/fastestimator/dataset/numpy_dataset.py/#L22-L44>View source on Github</a>
```python
NumpyDataset(
