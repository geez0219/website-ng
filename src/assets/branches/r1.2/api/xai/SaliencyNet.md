## SaliencyNet<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/xai/saliency.py/#L44-L267>View source on Github</a>
```python
SaliencyNet(
	model: ~Model,
