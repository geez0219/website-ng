## ElasticTransform<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/multivariate/elastic_transform.py/#L25-L91>View source on Github</a>
```python
ElasticTransform(
	alpha: float=34.0,
	sigma: float=4.0,
