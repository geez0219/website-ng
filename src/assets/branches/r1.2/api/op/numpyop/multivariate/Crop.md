## Crop<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/multivariate/crop.py/#L25-L83>View source on Github</a>
```python
Crop(
	x_min: int=0,
	y_min: int=0,
...
* **y_max**: Maximum lower right y coordinate. Image types: uint8, float32
