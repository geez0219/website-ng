...
## MultiVariateAlbumentation<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/multivariate/multivariate.py/#L26-L99>View source on Github</a>
```python
