## PadIfNeeded<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/multivariate/pad_if_needed.py/#L26-L92>View source on Github</a>
```python
PadIfNeeded(
	min_height: int=1024,
	min_width: int=1024,
