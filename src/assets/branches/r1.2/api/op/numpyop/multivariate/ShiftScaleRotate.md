## ShiftScaleRotate<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/multivariate/shift_scale_rotate.py/#L26-L103>View source on Github</a>
```python
ShiftScaleRotate(
