## HorizontalFlip<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/multivariate/horizontal_flip.py/#L25-L75>View source on Github</a>
```python
HorizontalFlip(
