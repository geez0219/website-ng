## MotionBlur<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/univariate/motion_blur.py/#L24-L46>View source on Github</a>
```python
MotionBlur(
