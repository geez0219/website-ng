## Downscale<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/univariate/downscale.py/#L25-L52>View source on Github</a>
```python
Downscale(
