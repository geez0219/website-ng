## ExpandDims<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/numpyop/univariate/expand_dims.py/#L24-L45>View source on Github</a>
```python
ExpandDims(
