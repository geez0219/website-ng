## LambdaOp<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/tensorop/tensorop.py/#L109-L130>View source on Github</a>
```python
LambdaOp(
	fn: Callable,
