## Sometimes<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/op/tensorop/meta/sometimes.py/#L29-L94>View source on Github</a>
```python
Sometimes(
