## Estimator<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/estimator.py/#L46-L459>View source on Github</a>
```python
Estimator(
