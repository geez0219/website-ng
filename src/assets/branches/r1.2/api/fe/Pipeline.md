## Pipeline<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/pipeline.py/#L41-L388>View source on Github</a>
```python
Pipeline(
