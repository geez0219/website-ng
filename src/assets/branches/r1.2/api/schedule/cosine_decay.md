## cosine_decay<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/schedule/lr_shedule.py/#L30-L73>View source on Github</a>
```python
cosine_decay(
	time: int,
	cycle_length: int,
