## Cropping2D<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/layers/pytorch/cropping_2d.py/#L21-L75>View source on Github</a>
```python
Cropping2D(
