## ContainerList<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/util/latex_util.py/#L25-L36>View source on Github</a>
```python
ContainerList(
	*, data=None
)
