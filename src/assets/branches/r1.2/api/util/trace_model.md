## trace_model<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/util/traceability_util.py/#L1096-L1126>View source on Github</a>
```python
trace_model(
	model: ~Model,
	model_idx: int,
