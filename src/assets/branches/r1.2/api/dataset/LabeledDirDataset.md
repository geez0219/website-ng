## LabeledDirDataset<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/dataset/labeled_dir_dataset.py/#L24-L85>View source on Github</a>
```python
LabeledDirDataset(
	root_dir: str,
	data_key: str='x',
