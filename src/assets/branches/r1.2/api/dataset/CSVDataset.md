## CSVDataset<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/dataset/csv_dataset.py/#L24-L40>View source on Github</a>
```python
CSVDataset(
	file_path: str,
