## gather<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/backend/gather.py/#L28-L79>View source on Github</a>
```python
gather(
	tensor: ~Tensor,
	indices: ~Tensor
