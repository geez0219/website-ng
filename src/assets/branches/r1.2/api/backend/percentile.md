## percentile<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/backend/percentile.py/#L28-L114>View source on Github</a>
```python
percentile(
	tensor: ~Tensor,
