## concat<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/backend/concat.py/#L24-L67>View source on Github</a>
```python
concat(
	tensors: List[~Tensor],
	axis: int=0
