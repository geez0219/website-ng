## squeeze<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/backend/squeeze.py/#L24-L71>View source on Github</a>
```python
squeeze(
	tensor: ~Tensor,
