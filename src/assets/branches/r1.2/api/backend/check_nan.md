## check_nan<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/backend/check_nan.py/#L22-L54>View source on Github</a>
```python
check_nan(
