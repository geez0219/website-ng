## sort_traces<span class="tag">function</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/trace.py/#L304-L374>View source on Github</a>
```python
sort_traces(
