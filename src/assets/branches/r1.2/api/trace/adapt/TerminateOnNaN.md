## TerminateOnNaN<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/adapt/terminate_on_nan.py/#L25-L67>View source on Github</a>
```python
TerminateOnNaN(
