## Traceability<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/io/traceability.py/#L68-L698>View source on Github</a>
```python
Traceability(
	save_path: str,
