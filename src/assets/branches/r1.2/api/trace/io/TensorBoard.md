## TensorBoard<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/io/tensorboard.py/#L269-L431>View source on Github</a>
```python
TensorBoard(
	log_dir: str='logs',
