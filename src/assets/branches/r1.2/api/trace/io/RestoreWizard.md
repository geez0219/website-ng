## RestoreWizard<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/io/restore_wizard.py/#L27-L109>View source on Github</a>
```python
RestoreWizard(
	directory: str,
	frequency: int=1
