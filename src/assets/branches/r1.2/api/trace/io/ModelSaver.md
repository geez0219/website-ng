## ModelSaver<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/io/model_saver.py/#L29-L62>View source on Github</a>
```python
ModelSaver(
