## TestReport<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/io/test_report.py/#L86-L526>View source on Github</a>
```python
TestReport(
