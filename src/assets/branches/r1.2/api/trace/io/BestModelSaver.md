## BestModelSaver<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/io/best_model_saver.py/#L29-L92>View source on Github</a>
```python
BestModelSaver(
