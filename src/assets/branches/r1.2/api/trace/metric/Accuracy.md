## Accuracy<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/metric/accuracy.py/#L26-L78>View source on Github</a>
```python
Accuracy(
	true_key: str,
	pred_key: str,
