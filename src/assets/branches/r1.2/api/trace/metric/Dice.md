## Dice<span class="tag">class</span><a class="sourcelink" href=https://github.com/fastestimator/fastestimator/blob/r1.2/fastestimator/trace/metric/dice.py/#L26-L73>View source on Github</a>
```python
Dice(
	true_key: str,
	pred_key: str,
